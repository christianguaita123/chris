...
public class CategoriaController {
    ...
    public String add(@RequestParam("idCategoria") @Nullable Integer idCategoria,
        ...
        if (idCategoria == null) {
        	Categoria otraCategoria = new Categoria (0, categoria, descripcion); 
            categoriaDAO.add(otraCategoria);
        } else {
        	Categoria otraCategoria = new Categoria (idCategoria, categoria, descripcion);
        	categoriaDAO.up(otraCategoria);
        }
